...
public:
     ...
     * be encoded as AAC.
     * If there is already a recording in progress, calling this function will throw an exception.
     * WARNING: If the specified output file already exists, this function will simply overwrite it without performing
     * any check
